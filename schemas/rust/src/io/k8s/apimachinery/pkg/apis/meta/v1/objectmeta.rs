...
pub struct ObjectMeta {
    ...
    pub creation_timestamp: Option<crate::io::k8s::apimachinery::pkg::apis::meta::v1::Time>,
    ...
    pub deletion_timestamp: Option<crate::io::k8s::apimachinery::pkg::apis::meta::v1::Time>,
    ...
    #[serde(rename = "managedFields", default, skip_serializing_if = "Option::is_none")]
    pub managed_fields: Option<Vec<crate::io::k8s::apimachinery::pkg::apis::meta::v1::ManagedFieldsEntry>>,
    ...
    #[serde(rename = "ownerReferences", default, skip_serializing_if = "Option::is_none")]
    pub owner_references: Option<Vec<crate::io::k8s::apimachinery::pkg::apis::meta::v1::OwnerReference>>,
